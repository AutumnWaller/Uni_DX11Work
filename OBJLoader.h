...
namespace OBJLoader
{
	...
	bool FindSimilarVertex(const StaticStructs::StandardVertex& vertex, std::map<StaticStructs::StandardVertex, unsigned short>& vertToIndexMap, unsigned short& index);
